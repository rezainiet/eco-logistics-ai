...
type AuditAction =
  ...
  | "automation.ivr_confirm"
  | "automation.ivr_reject"
  | "automation.whatsapp_confirm"
  | "automation.whatsapp_reject"
  | "automation.manual_confirm"
  | "automation.manual_reject"
  | "automation.agent_confirm"
  | "automation.agent_reject"
  | "automation.ai_voice_confirm"
  | "automation.ai_voice_reject"
